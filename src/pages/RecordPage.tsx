...
import { ArrowLeft, Calendar, ExternalLink, Video, FileText, Link as LinkIcon, StickyNote, ChevronDown, ChevronUp } from "lucide-react";
    ...
    return (
      <div className="min-h-screen bg-background">
        ...
        <div className="container mx-auto px-6 py-16 text-center">
          ...
          <p className="text-muted-foreground mb-4">The record you're looking for doesn't exist.</p>
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-6 py-8 max-w-3xl">
        ...
        <motion.article initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }}>
          <h1 className="text-3xl md:text-4xl font-bold text-foreground mb-4">{record.title}</h1>
          ...
          {record.sourceUrl && (
            <a href={record.sourceUrl} target="_blank" rel="noopener noreferrer"
              ...
              <span className="text-sm text-primary truncate">{record.sourceUrl}</span>
            </a>
          )}
          ...
          <section className="mb-8">
            ...
            <div className="rounded-xl border border-border bg-card p-5">
              <p className="text-foreground/90 leading-relaxed">{record.summary}</p>
            </div>
          </section>
          ...
          <section className="mb-8">
            ...
            {rawExpanded && (
              <motion.div initial={{ height: 0, opacity: 0 }} animate={{ height: "auto", opacity: 1 }}>
                <div className="rounded-xl border border-border bg-card p-5">
                  <p className="text-sm text-muted-foreground leading-relaxed whitespace-pre-wrap">{record.rawContent}</p>
                </div>
              </motion.div>
            )}
          </section>
